...
public class Basculin extends Pokèmon{
	 ...
	 */
	public Basculin(Abilities ability){
	 ...
	 */
	public Basculin(HiddenAbilities ability){
		super("Basculin", Type.ACQUA, 92, 65, 80, 55, 98, 70, 4, 40, 161, ability);
		setMoves(new Idrondata());
		setMoves(new Geloraggio());
		setMoves(new Cascata());
	 ...
	 * @param ability : Abilities
	 */
	public Basculin(String nome, int Attacco, int Difesa, int AttaccoSp, int DifesaSp, int Velocità, int HP, 
