...
public class Cofagrigus extends Pokèmon{
	Cofagrigus(){
		super("Cofagrigus", Type.SPETTRO, 50, 145, 95, 105, 30, 58, 4, 35, 169);
	...
	Cofagrigus(String nome, int Attacco, int Difesa, int AttaccoSp, int DifesaSp, int Velocità, int HP, 
