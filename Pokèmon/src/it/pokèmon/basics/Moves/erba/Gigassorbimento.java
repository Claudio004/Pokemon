...
/**
 * Pokèmon's move: <b>Gigassorbimento</b><br>
 * Extends Move<br>
 * Move informations:
 * <ul>
 * 	<li>Type: <b>ERBA</b></li>
 ...
 */
public class Gigassorbimento extends Move{
	private int pp = 10;

	/**
	 * Gigassorbimento move constructor
	 */
	public Gigassorbimento() {
		super("Gigassorbimento", Type.ERBA, 75, 100);
	}
