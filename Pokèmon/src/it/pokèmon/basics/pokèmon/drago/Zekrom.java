...
public class Zekrom extends Pokèmon{
	Zekrom(){
		super("Zekrom", Type.DRAGO, Type.ELETTRO, 150, 120, 120, 100, 90, 100, 4, 65, 340);
	...
	Zekrom(String nome, int Attacco, int Difesa, int AttaccoSp, int DifesaSp, int Velocità, int HP, 
		...
		super(nome, Type.DRAGO, Type.ELETTRO, Attacco, Difesa, AttaccoSp, DifesaSp, Velocità, HP, movesNumber, Level, exp);
