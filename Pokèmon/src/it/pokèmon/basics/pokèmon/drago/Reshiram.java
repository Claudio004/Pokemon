...
public class Reshiram extends Pokèmon{
	Reshiram(){
		super("Reshiram", Type.DRAGO, Type.FUOCO, 120, 100, 150, 120, 90, 100, 4, 65, 340);
	...
	Reshiram(String nome, int Attacco, int Difesa, int AttaccoSp, int DifesaSp, int Velocità, int HP, 
		...
		super(nome, Type.DRAGO, Type.FUOCO, Attacco, Difesa, AttaccoSp, DifesaSp, Velocità, HP, movesNumber, Level, exp);
